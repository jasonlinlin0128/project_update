<template>
  <div class="card h-full flex flex-col overflow-hidden border-t-4 border-accent-yellow hover:shadow-lg transition-shadow duration-300">
    ...
    <div class="p-4 flex-grow bg-white">
      <div class="space-y-3">
        <div v-for="item in items" :key="item.id" class="group bg-white p-4 rounded-xl border border-gray-100 flex justify-between items-center hover:shadow-md hover:border-accent-yellow transition-all duration-300">
          <div>
